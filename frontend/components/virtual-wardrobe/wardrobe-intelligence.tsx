...
export function WardrobeIntelligence() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="mb-1 bg-gradient-to-r from-purple-200 to-rose-200 bg-clip-text font-serif text-2xl text-transparent">
      ...
      <div className="space-y-4">
        <h3 className="text-sm font-medium text-white">Wardrobe Balance</h3>
        <div className="relative flex items-center justify-center py-4">
          {/* Custom circular progress visualization using SVG */}
          <div className="relative h-40 w-40">
            <svg className="h-full w-full -rotate-90 transform" viewBox="0 0 100 100">
              <circle className="stroke-white/10" strokeWidth="8" fill="transparent" r="40" cx="50" cy="50" />
              <circle
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-medium text-white">Missing Essentials</h3>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Card className="border-dashed border-white/20 bg-transparent transition-colors hover:border-white/40 hover:bg-white/5">
            <CardContent className="flex flex-col items-center justify-center gap-2 p-4 text-center">
              ...
              <span className="text-xs font-medium text-white">White Tee</span>
              <Button
                variant="ghost"
                size="sm"
          ...
          <Card className="border-dashed border-white/20 bg-transparent transition-colors hover:border-white/40 hover:bg-white/5">
            <CardContent className="flex flex-col items-center justify-center gap-2 p-4 text-center">
              ...
              <span className="text-xs font-medium text-white">Black Blazer</span>
              <Button
                variant="ghost"
                size="sm"
                className="h-6 w-full text-[10px] text-purple-400 hover:text-purple-300"
      ...
      {/* Daily Pick */}
      <Card className="overflow-hidden border-none bg-gradient-to-br from-purple-900/40 to-slate-900/40">
        <CardContent className="p-5">
          ...
          <p className="mb-4 font-serif text-lg leading-snug text-white">
            Wear your <span className="font-italic text-purple-300">Blue Silk Shirt</span> today - It matches the mild
            weather.
          </p>
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 overflow-hidden rounded-md bg-black/20">
              <img
